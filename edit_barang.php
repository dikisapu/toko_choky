...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE barang SET nama_barang='$nama_barang' WHERE barang_id='$barang_id'";
    ...
    // Perbaiki kueri ini dengan menambahkan FROM barang
    $sql_get_updated_data = "SELECT barang_id, nama_barang FROM barang WHERE barang_id='$barang_id'";
    $result = $conn->query($sql_get_updated_data);
...
if (isset($_GET['id'])) {
    $barang_id = $_GET['id'];
    $sql = "SELECT barang_id, nama_barang FROM barang WHERE barang_id='$barang_id'";
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="edit_barang.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="barang_id" name="barang_id" value="<?php echo isset($row['barang_id']) ? $row['barang_id'] : ''; ?>" class="form-control" readonly>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="nama_barang">Nama Barang</label>
                                            <input type="text" id="nama_barang" name="nama_barang" value="<?php echo isset($row['nama_barang']) ? $row['nama_barang'] : ''; ?>" class="form-control" required>
                                        </div>
