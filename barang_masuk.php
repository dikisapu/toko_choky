...
if (isset($_GET['hapus'])) {
    $id_masuk = $_GET['hapus'];
    $sql_hapus = "DELETE FROM barang_masuk WHERE id_masuk = '$id_masuk'";
...
$sql = "SELECT id_masuk, tanggal, bahan, nama_suplier, qty, total_jumlah FROM barang_masuk";
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <a href="tambah_barang_masuk.php" class="btn btn-primary btn-sm mb-3">Tambah Barang Masuk</a>
                                                    ...
                                                    <?php if ($result->num_rows > 0) : ?>
                                                        <?php while ($row = $result->fetch_assoc()) : ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo formatRupiah($row['total_jumlah']); ?></td>
                                                                <td>
                                                                    <a href="detail_barang_masuk.php?id=<?php echo $row['id_masuk']; ?>" class="btn btn-info btn-sm">Detail</a>
                                                                    <a href="?hapus=<?php echo $row['id_masuk']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini?')">Hapus</a>
                                                                </td>
                                                            </tr>
                                                        <?php endwhile; ?>
                                                    <?php else : ?>
