                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <a href="tambah_barang.php" class="btn btn-primary btn-sm mb-3">Tambah Barang</a>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php
                                                    include 'config.php';
                                                    $sql = "SELECT barang_id, nama_barang, total_kuantitas
                                                    FROM barang";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>";
                                                            echo "<a href='edit_barang.php?id=" . $row["barang_id"] . "' class='btn btn-warning btn-sm'>Edit</a> ";
                                                            echo "<a href='hapus_barang.php?id=" . $row["barang_id"] . "' class='btn btn-danger btn-sm'>Hapus</a>";
                                                            echo "</td>";
                                                            echo "</tr>";
                                                        }
                                                    } else {
